const API_BASE = window.CLOUD_NANDY_API_URL || (window.location.hostname === "localhost" || window.location.hostname === "127.0.0.1" ? "http://localhost:3000" : "https://cloud-nandy-api.onrender.com");
